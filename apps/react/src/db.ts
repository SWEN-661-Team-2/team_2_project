...
db.on('populate', () => {
  ...
  db.patients.bulkAdd([
    { firstName: 'John',   lastName: 'Davis',    initials: 'JD', room: '204A', age: 68, gender: 'Male',   status: 'stable',    phone: '(555) 123-4567', email: 'john.davis@email.com',    diagnosis: ['Hypertension', 'Type 2 Diabetes', 'Chronic Kidney Disease'], medications: ['Metformin 500mg', 'Lisinopril 10mg', 'Atorvastatin 20mg', 'Aspirin 81mg'],                                                       admissionDate: '2026-02-20', allergies: ['Penicillin', 'Sulfa'], bloodType: 'A+'  },
    { firstName: 'Mary',   lastName: 'Wilson',   initials: 'MW', room: '301B', age: 54, gender: 'Female', status: 'improving', phone: '(555) 234-5678', email: 'mary.wilson@email.com',   diagnosis: ['Post-operative Recovery', 'Anemia', 'Hypertension'],         medications: ['Iron Supplement', 'Ferrous Sulfate 325mg', 'Metoprolol 25mg'],                                                                        admissionDate: '2026-02-22', allergies: ['Latex'],              bloodType: 'O-'  },
    { firstName: 'Robert', lastName: 'Brown',    initials: 'RB', room: '156C', age: 72, gender: 'Male',   status: 'critical',  phone: '(555) 345-6789', email: 'robert.brown@email.com',  diagnosis: ['Pneumonia', 'COPD', 'Heart Failure', 'Type 2 Diabetes'],     medications: ['Amoxicillin 875mg', 'Albuterol Inhaler', 'Furosemide 40mg', 'Metformin 1000mg', 'Carvedilol 12.5mg', 'Spironolactone 25mg'],          admissionDate: '2026-02-24', allergies: ['Aspirin', 'Codeine'], bloodType: 'B+'  },
    { firstName: 'Lisa',   lastName: 'Anderson', initials: 'LA', room: '412A', age: 45, gender: 'Female', status: 'stable',    phone: '(555) 456-7890', email: 'lisa.anderson@email.com', diagnosis: ['Migraines', 'Anxiety Disorder', 'Hypothyroidism'],           medications: ['Sertraline 50mg', 'Levothyroxine 75mcg', 'Sumatriptan 50mg', 'Propranolol 10mg'],                                                     admissionDate: '2026-02-21', allergies: ['None known'],         bloodType: 'AB+' },
    { firstName: 'James',  lastName: 'Miller',   initials: 'JM', room: '218B', age: 61, gender: 'Male',   status: 'improving', phone: '(555) 567-8901', email: 'james.miller@email.com',  diagnosis: ['CAD', 'Hypertension', 'Hyperlipidemia', 'Obesity', 'Sleep Apnea'], medications: ['Atorvastatin 40mg', 'Amlodipine 5mg', 'Lisinopril 20mg', 'Clopidogrel 75mg', 'Metoprolol 50mg', 'Nitroglycerin PRN', 'Aspirin 81mg'], admissionDate: '2026-01-19', allergies: ['Ibuprofen'],          bloodType: 'O+'  },
  ]);
