  ...
  return (
    <div className="min-h-screen bg-transparent pb-20 lg:pb-0">
              ...
              {selectedPatient ? (
                <div>
                  ...
                  <div className="p-6 md:p-8 space-y-8">
                    ...
                    <button className="w-full h-14 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-bold rounded-xl shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98] transition-all">
                ...
                <div className="flex items-center justify-center h-full min-h-[600px] p-8 text-center bg-white dark:bg-slate-800">
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400 max-w-xs mx-auto mb-8">Select a patient to view full medical records and history.</p>
                  </div>
                </div>
              )}
            </div>
      ...
      <AddPatientModal
        ...
        onSubmit={(data) => { console.log(data); setPatientModalOpen(false); }}
      />
    </div>
  );
}