...
// Filter tab identifiers — matches Task['status'] values plus 'all'
type FilterTab = 'all' | 'pending' | 'in-progress' | 'completed';

// Tab definitions — used to render both desktop and mobile filter bars
...
export function TaskManagement() {
  ...
  // 1. Pull all tasks from IndexedDB.
  // useLiveQuery re-renders automatically whenever the tasks table changes.
  const tasksFromDb = useLiveQuery(() => db.tasks.toArray()) || [];

  // 2. Filter tasks client-side by active status tab and search query.
  // Matches on task title or patient name.
  ...
  // Updates a task's status in IndexedDB — triggers live query re-render
  ...
  // Icon shown next to the task title reflecting current status
  ...
  // Returns Tailwind classes for the status badge chip at the bottom of each card
    ...
    <div className="min-h-screen bg-transparent pb-20 lg:pb-0">
      <div className="p-4 md:p-6 lg:p-8">
        <div className="mb-6 md:mb-8">
          ...
          {/* Page Header — title and New Task button */}
          ...
          {/* Search bar — filters by task title or patient name */}
          <div className="mb-6">
          ...
          {/* Filter Tabs — desktop: underline style, mobile: pill style */}
          ...
          {/* Mobile filter tabs — horizontally scrollable pill buttons */}
                ...
                return (
                  ...
                  >
                    <div className="p-5 md:p-6">
                      ...
                      {/* Task footer — status chip and action buttons */}
                      <div className="flex items-center justify-between pt-4 border-t border-slate-100 dark:border-slate-700">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {/* Start Task — only shown for pending tasks */}
                          {task.status === 'pending' && (
                            <button
                          ...
                          {/* Complete — only shown for in-progress tasks */}
